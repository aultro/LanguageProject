...
#line 2 "zoomjoystrong.y" /* yacc.c:339  */
...
#line 80 "zoomjoystrong.tab.c" /* yacc.c:339  */
...
#line 143 "zoomjoystrong.tab.c" /* yacc.c:358  */
...
{
  "$end", "error", "$undefined", "END", "END_STATEMENT", "LINE", "CIRCLE",
  "POINT", "RECTANGLE", "SET_COLOR", "INT", "FLOAT", "$accept", "program",
...
static const yytype_int8 yypact[] =
{
       ...
       8,     9,    10,    11,   -10,    18,   -10,    13,    14,    21,
      16,    23,   -10,    19,    24,   -10,    20,   -10,    27,   -10,
      28,   -10,   -10
};
...
#line 33 "zoomjoystrong.y" /* yacc.c:1648  */
    {if((yyvsp[-4])<1024 && (yyvsp[-3])<1024 && (yyvsp[-2])<768 && (yyvsp[-1])<768){
									 line((yyvsp[-4]), (yyvsp[-2]), (yyvsp[-3]), (yyvsp[-1]));}
...
#line 39 "zoomjoystrong.y" /* yacc.c:1648  */
    {if((yyvsp[-3])+(yyvsp[-1])<1024 && (yyvsp[-2])+(yyvsp[-1])<768){
							circle((yyvsp[-3]), (yyvsp[-2]), (yyvsp[-1]));}
							else{yyerror("circle points out of bounds");};  }
#line 1245 "zoomjoystrong.tab.c" /* yacc.c:1648  */
    break;

  case 8:
#line 42 "zoomjoystrong.y" /* yacc.c:1648  */
    {if( (yyvsp[-4])+(yyvsp[-2])<1024 && (yyvsp[-3])+(yyvsp[-1])<768){
...
#line 45 "zoomjoystrong.y" /* yacc.c:1648  */
    {if((yyvsp[-2])<225 && (yyvsp[-1])<225 && (yyvsp[0])<225){
							set_color( (yyvsp[-2]),(yyvsp[-1]),(yyvsp[0]));} 
							else{yyerror("color invalid");};	}
#line 1261 "zoomjoystrong.tab.c" /* yacc.c:1648  */
    break;
